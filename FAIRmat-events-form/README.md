...
This is a plugin to enable collection of events requests from FAIRmat members using NOMAD
...
```sh
git clone https://github.com/ahm531/FAIRmat-events-form.git
cd FAIRmat-events-form
...
| Name | E-mail     |
|------|------------|
| Ahmed Mansour | [ahm531@gmail.com](mailto:ahm531@gmail.com)
